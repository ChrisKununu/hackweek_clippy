...
def extract_document(
    ...
    min_length: int = 20,
    columns: tuple = relevant_cols) -> list[Document]:
...
if __name__ == '__main__':
    ...
    test_extract = extract_document(df)
    pprint(test_extract[0].to_dict())
    
    ds.write_documents(test_extract, index=config['review_index'])
